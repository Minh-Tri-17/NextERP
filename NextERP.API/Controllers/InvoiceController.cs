...
namespace NextERP.API.Controllers
{
    ...
    public class InvoiceController : ControllerBase
    {
        ...
        [HttpDelete(nameof(DeletePermanentlyInvoice))]
        public async Task<ActionResult<APIBaseResult<bool>>> DeletePermanentlyInvoice(string ids)
        {
            var result = await _invoiceService.DeletePermanently(ids);
            if (!result.IsSuccess)
                return BadRequest(result);
        ...
        public async Task<ActionResult<IEnumerable<Invoice>>> GetInvoices()
        {
            ...
            var result = await _invoiceService.GetPaging(invoice);
            if (!result.IsSuccess)
                return BadRequest(result);
