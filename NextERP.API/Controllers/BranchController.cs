...
namespace NextERP.API.Controllers
{
    ...
    public class BranchController : ControllerBase
    {
        ...
        [HttpDelete(nameof(DeletePermanentlyBranch))]
        public async Task<ActionResult<APIBaseResult<bool>>> DeletePermanentlyBranch(string ids)
        {
            var result = await _branchService.DeletePermanently(ids);
            if (!result.IsSuccess)
                return BadRequest(result);
