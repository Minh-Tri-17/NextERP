...
namespace NextERP.API.Controllers
{
    ...
    public class LeaveRequestController : ControllerBase
    {
        ...
        [HttpDelete(nameof(DeletePermanentlyLeaveRequest))]
        public async Task<ActionResult<APIBaseResult<bool>>> DeletePermanentlyLeaveRequest(string ids)
        {
            var result = await _leaveRequestService.DeletePermanently(ids);
            if (!result.IsSuccess)
                return BadRequest(result);
        ...
        public async Task<ActionResult<IEnumerable<LeaveRequest>>> GetLeaveRequests(FilterModel filter)
        {
        ...
        public async Task<ActionResult<APIBaseResult<byte[]>>> ExportLeaveRequest(FilterModel filter)
        {
