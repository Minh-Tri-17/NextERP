...
namespace NextERP.API.Controllers
{
    ...
    public class SpaServiceCategoriesController : ControllerBase
    {
        private readonly ISpaServiceCategoryService _spaServiceCategoryService;

        public SpaServiceCategoriesController(ISpaServiceCategoryService spaServiceCategoryService)
        {
        ...
        public async Task<ActionResult<APIBaseResult<byte[]>>> ExportSpaServiceCategory(Filter filter)
        {
            ...
            var fileName = string.Format(Constants.FileName, ObjectNames.SpaServiceCategory, DateTime.Now.ToString(Constants.DateTimeString));
