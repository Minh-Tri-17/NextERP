...
namespace NextERP.MVC.Admin.Controllers
{
    public class ProductCategoryController : BaseController
    {
        ...
        [HttpPost]
        public async Task<ActionResult> GetList(ProductCategoryModel request)
        {
            FilterModel filter = new FilterModel()
            {
                Filters = new List<FilterItemModel>()
                {
                    ...
                    new FilterItemModel()
                    {
                        FilterName = ProductCategoryModel.AttributeNames.ProductCategoryCode,
                        FilterValue = DataHelper.GetString(request.ProductCategoryCode),
        ...
        [HttpPost]
        public async Task<ActionResult> Export(ProductCategoryModel request)
        {
            FilterModel filter = new FilterModel()
            {
                Filters = new List<FilterItemModel>()
