...
namespace NextERP.MVC.Admin.Controllers
{
    public class CustomerController : BaseController
    {
        ...
        [HttpPost]
        public async Task<ActionResult> GetList(CustomerModel request)
        {
            FilterModel filter = new FilterModel()
            {
                Filters = new List<FilterItemModel>()
                {
                    ...
                    new FilterItemModel()
                    {
                        FilterName = CustomerModel.AttributeNames.CustomerCode,
                        FilterValue = DataHelper.GetString(request.CustomerCode),
                        FilterType = Util.Enums.FilterType.String.ToString(),
                        FilterOperator = Util.Enums.FilterOperator.Like.ToString(),
                    },
                    new FilterItemModel()
                    {
                        FilterName = CustomerModel.AttributeNames.OperatingStatus,
                        FilterValue = DataHelper.GetString(request.CustomerCode),
                        FilterType = Util.Enums.FilterType.String.ToString(),
        ...
        [HttpPost]
        public async Task<ActionResult> Export(CustomerModel request)
        {
            FilterModel filter = new FilterModel()
            {
                Filters = new List<FilterItemModel>()
