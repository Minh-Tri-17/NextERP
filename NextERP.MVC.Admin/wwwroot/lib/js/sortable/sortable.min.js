...
!(function (t, e) {
  ...
  function k(t, e, n) {
    ...
    t &&
      ...
      (t.classList
        ...
        : ((o = (" " + t.className + " ").replace(v, " ").replace(" " + e + " ", " ")),
  ...
  function X(t, e, n, o, i) {
    if (t.getBoundingClientRect || t === window) {
      ...
      return (
        o &&
          t !== window &&
          ((o = (e = b(i || t)) && e.a), (t = e && e.d), e && ((s = (a /= t) + (u /= t)), (c = (l /= o) + (d /= o)))),
  ...
  function F(t, e) {
    for (var n = t.lastElementChild; n && (n === jt.ghost || "none" === R(n, "display") || (e && !f(n, e))); )
  ...
  function j(t, e) {
    ...
    for (; (t = t.previousElementSibling); )
      "TEMPLATE" === t.nodeName.toUpperCase() || t === jt.clone || (e && !f(t, e)) || n++;
    return n;
  }
  function E(t) {
    var e = 0,
          ...
          this.options.animation &&
            [].slice.call(this.el.children).forEach(function (t) {
              ...
              "none" !== R(t, "display") &&
                ...
                !t.thisAnimationDuration || ((n = b(t, !0)) && ((e.top -= n.f), (e.left -= n.e))),
                (t.fromRect = e));
            });
      },
          ...
          s && ((i.top -= s.f), (i.left -= s.e)),
            ...
            n.thisAnimationDuration &&
              ...
              (e =
                ...
                a.animation)),
            S(i, o) ||
              ((n.prevFromRect = o), (n.prevToRect = i), (e = e || c.options.animation), c.animate(n, l, i, e)),
            e &&
              ((u = !0),
              (d = Math.max(d, e)),
      ...
      initializePlugins: function (n, o, i, t) {
        for (var e in (N.forEach(function (t) {
          ...
          (n.options[e] || t.initializeByDefault) &&
            (((t = new t(n, o, n.options)).sortable = n), (t.options = n.options), (n[e] = t), a(i, t.defaults));
        }),
        n.options)) {
          var r;
  ...
  function G(t) {
    ...
    if ((e = e || (n && n[K]))) {
      ...
      var v,
        b = I(I({}, f), z.getEventProperties(o, e));
      for (v in b) g[v] = b[v];
  ...
  function jt(t, e) {
    ...
    (this.nativeDraggable = !e.forceFallback && It),
      ...
      e.supportPointer
        ...
        : (h(t, "mousedown", this._onTapStart), h(t, "touchstart", this._onTapStart)),
  ...
  (jt.prototype = {
      ...
      if (e.cancelable) {
        ...
        if (
          ...
          !Z &&
            ...
            !(((l = P(l, t.draggable, o, !1)) && l.animated) || et === l))
        ) {
          if (((it = j(l)), (at = j(l, t.draggable)), "function" == typeof c)) {
            if (c.call(this, e, l, this))
              return (
                V({ sortable: n, rootEl: s, name: "filter", targetEl: l, toEl: o, fromEl: o }),
                U("filter", n, { evt: e }),
            ...
            (c =
              ...
              c.split(",").some(function (t) {
                if ((t = P(s, t.trim(), o, !1)))
                  return (
                    V({ sortable: n, rootEl: t, name: "filter", targetEl: l, fromEl: o, toEl: o }),
                    U("filter", n, { evt: e }),
                    !0
                  );
              }))
    ...
    _prepareDragStart: function (t, e, n) {
      ...
      n &&
        ...
        (et = n),
        (st = a.group),
        (ut = { target: (jt.dragged = Z), clientX: (e || t).clientX, clientY: (e || t).clientY }),
        (ft = ut.clientX - o.left),
        (gt = ut.clientY - o.top),
        (this._lastX = (e || t).clientX),
        (this._lastY = (e || t).clientY),
        (Z.style["will-change"] = "all"),
        (o = function () {
          U("delayEnded", i, { evt: t }),
            jt.eventCanceled
              ? i._onDrop()
              : (i._disableDelayedDragEvents(),
                !s && i.nativeDraggable && (Z.draggable = !0),
                i._triggerDragStart(t, e),
                V({ sortable: i, name: "choose", originalEvent: t }),
                k(Z, a.chosenClass, !0));
        }),
        ...
        h(l, "touchmove", Bt),
        a.supportPointer
          ? (h(l, "pointerup", i._onDrop), this.nativeDraggable || h(l, "pointercancel", i._onDrop))
          : (h(l, "mouseup", i._onDrop), h(l, "touchend", i._onDrop), h(l, "touchcancel", i._onDrop)),
        s && this.nativeDraggable && ((this.options.touchStartThreshold = 4), (Z.draggable = !0)),
        U("delayStart", this, { evt: t }),
        !a.delay || (a.delayOnTouchOnly && !e) || (this.nativeDraggable && (w || y))
          ? o()
          : jt.eventCanceled
          ? this._onDrop()
          : (a.supportPointer
              ? (h(l, "pointerup", i._disableDelayedDrag), h(l, "pointercancel", i._disableDelayedDrag))
    ...
    _disableDelayedDragEvents: function () {
      ...
      p(t, "mouseup", this._disableDelayedDrag),
        ...
        p(t, "pointerup", this._disableDelayedDrag),
        p(t, "pointercancel", this._disableDelayedDrag),
    ...
    _triggerDragStart: function (t, e) {
      (e = e || ("touch" == t.pointerType && t)),
        !this.nativeDraggable || e
          ...
          : (h(Z, "dragend", this), h(J, "dragstart", this._onDragStart));
      try {
        document.selection
          ? Wt(function () {
    ...
    _emulateDragOver: function () {
      if (dt) {
        ...
        for (
          ...
          t && t.shadowRoot && (t = t.shadowRoot.elementFromPoint(dt.clientX, dt.clientY)) !== e;
        ...
        if ((Z.parentNode[K]._isOutsideThisEl(t), e))
          do {
            if (e[K])
              if (
                e[K]._onDragOver({ clientX: dt.clientX, clientY: dt.clientY, target: t, rootEl: e }) &&
    ...
    _onTouchMove: function (t) {
      if (ut) {
        ...
        Q &&
          (r ? ((r.e += a - (ht || 0)), (r.f += l - (pt || 0))) : (r = { a: 1, b: 0, c: 0, d: 1, e: a, f: l }),
          (r = "matrix("
            .concat(r.a, ",")
            .concat(r.b, ",")
            .concat(r.c, ",")
      ...
      if (!Q) {
        ...
        if (At) {
          ...
          wt !== document.body && wt !== document.documentElement
            ? (wt === document && (wt = O()), (e.top += wt.scrollTop), (e.left += wt.scrollLeft))
            : (wt = O()),
            (Tt = E(wt));
        }
        k((Q = Z.cloneNode(!0)), n.ghostClass, !1),
          ...
          R(
            Q,
            "transform-origin",
            (ft / parseInt(Q.style.width)) * 100 + "% " + (gt / parseInt(Q.style.height)) * 100 + "%"
          );
      }
    },
    _onDragStart: function (t, e) {
      var n = this,
        o = t.dataTransfer,
        i = n.options;
      U("dragStart", this, { evt: t }),
        jt.eventCanceled
          ? this._onDrop()
          : (U("setupClone", this),
            jt.eventCanceled ||
              ((nt = C(Z)).removeAttribute("id"),
              (nt.draggable = !1),
            ...
            (n.cloneId = Wt(function () {
              U("clone", n),
                jt.eventCanceled ||
                  (n.options.removeCloneOnHide || J.insertBefore(nt, Z),
                  n._hideClone(),
    ...
    _onDragOver: function (n) {
      ...
      if (!xt) {
        if (
          ...
          return g;
        if (Z.contains(n.target) || (l.animated && l.animatingX && l.animatingY) || f._ignoreWhileAnimating === l)
          return A(!1);
        if (
          ((Et = !1),
          u &&
            ...
            (d
              ? h || (i = $ !== J)
              : ct === this || ((this.lastPutMode = st.checkPull(this, u, Z, n)) && c.checkPut(this, u, Z, n))))
        ) {
          if (((r = "vertical" === this._getDirection(n, l)), (o = X(Z)), O("dragOverValid"), jt.eventCanceled))
            return g;
          if (i)
            return (
              ($ = J),
          ...
          if (
            ...
            ((S = n),
            (c = r),
            (x = X(F((E = this).el, E.options.draggable))),
            (E = L(E.el, E.options, Q)),
            !(c
              ? S.clientX > E.right + 10 || (S.clientY > x.bottom && S.clientX > x.left)
              : S.clientY > E.bottom + 10 || (S.clientX > x.right && S.clientY > x.top)) || m.animated)
          ) {
            if (
              m &&
              ((t = n),
              ...
              e
                ? t.clientX < _.left - 10 || (t.clientY < C.top && t.clientX < C.right)
                : t.clientY < _.top - 10 || (t.clientY < C.bottom && t.clientX < C.left))
            ) {
              var v = B(a, 0, s, !0);
              if (v === Z) return A(!1);
              if (((D = X((l = v))), !1 !== Ht(J, a, Z, o, l, D, n, !1)))
                return M(), a.insertBefore(Z, v), ($ = a), N(), A(!0);
              ...
              var b,
                ...
                E = Z.parentNode !== a,
                S =
                  ((S = (Z.animated && Z.toRect) || o),
                  (x = (l.animated && l.toRect) || D),
                  (_ = (e = r) ? S.left : S.top),
              ...
              if (
                (vt !== l && ((y = D[_]), (_t = !1), (Ct = (!S && s.invertSwap) || E)),
                0 !==
              ...
              if (!1 !== S)
                return (
                  ...
                  setTimeout(Kt, 30),
                  M(),
                  E && !x ? a.appendChild(Z) : l.parentNode.insertBefore(Z, E ? x : l),
            ...
            if (m === Z) return A(!1);
            if (((l = m && a === n.target ? m : l) && (D = X(l)), !1 !== Ht(J, a, Z, o, l, D, n, !!l)))
              return M(), m && m.nextSibling ? a.insertBefore(Z, m.nextSibling) : a.appendChild(Z), ($ = a), N(), A(!0);
          }
      ...
      function A(t) {
        return (
          ...
          t &&
            ...
            f !== p && (k(Z, (ct || u).options.ghostClass, !1), k(Z, s.ghostClass, !0)),
            ct !== f && f !== jt.active ? (ct = f) : f === jt.active && ct && (ct = null),
          ...
          s.dragoverBubble || n.rootEl || l === document || (Z.parentNode[K]._isOutsideThisEl(n.target), t || Bt(n)),
      ...
      function N() {
        (rt = j(Z)),
          (lt = j(Z, s.draggable)),
          V({ sortable: f, name: "change", toEl: a, newIndex: rt, newDraggableIndex: lt, originalEvent: n });
      }
    },
    ...
    _offMoveEvents: function () {
      p(document, "mousemove", this._onTouchMove),
        ...
        p(document, "dragover", Bt),
        p(document, "mousemove", Bt),
        p(document, "touchmove", Bt);
    },
    _offUpEvents: function () {
      ...
      p(t, "mouseup", this._onDrop),
        ...
        p(t, "pointercancel", this._onDrop),
    ...
    _onDrop: function (t) {
      ...
      (rt = j(Z)),
        ...
        jt.eventCanceled ||
          ...
          this.nativeDraggable && (p(document, "drop", this), p(e, "dragstart", this._onDragStart)),
          this._offMoveEvents(),
          this._offUpEvents(),
          ...
          t &&
            ...
            Z &&
              (this.nativeDraggable && p(Z, "dragend", this),
              Lt(Z),
              (Z.style["will-change"] = ""),
              mt && !Dt && k(Z, (ct || this).options.ghostClass, !1),
              ...
              J !== $
                ? (0 <= rt &&
                    (V({ rootEl: $, name: "add", toEl: $, fromEl: J, originalEvent: t }),
                    V({ sortable: this, name: "remove", toEl: $, originalEvent: t }),
                    V({ rootEl: $, name: "sort", toEl: $, fromEl: J, originalEvent: t }),
                    V({ sortable: this, name: "sort", toEl: $, originalEvent: t })),
                  ct && ct.save())
                : rt !== it &&
                  0 <= rt &&
                  (V({ sortable: this, name: "update", toEl: $, originalEvent: t }),
                  V({ sortable: this, name: "sort", toEl: $, originalEvent: t })),
              jt.active &&
                ((null != rt && -1 !== rt) || ((rt = it), (lt = at)),
                V({ sortable: this, name: "end", toEl: $, originalEvent: t }),
                this.save())))),
        this._nulling();
    },
    _nulling: function () {
    ...
    _showClone: function (t) {
      "clone" === t.lastPutMode
        ? ot &&
          (U("showClone", this),
          jt.eventCanceled ||
            (Z.parentNode != J || this.options.group.revertClone
              ? tt
  ...
  var ne,
      ...
      if (t.scroll) {
        ...
        do {
          var p = h,
            ...
            E =
              p === c
                ? ((D = y < S && ("auto" === C.overflowX || "scroll" === C.overflowX || "visible" === C.overflowX)),
                  w < _ && ("auto" === C.overflowY || "scroll" === C.overflowY || "visible" === C.overflowY))
                : ((D = y < S && ("auto" === C.overflowX || "scroll" === C.overflowX)),
            ...
            (0 == T && 0 == f) ||
              ...
              (Qt[d].pid = setInterval(
                function () {
                  ...
                  ("function" == typeof i &&
                    "continue" !== i.call(jt.dragged.parentNode[K], e, t, n, Zt, Qt[this.layer].el)) ||
                    H(Qt[this.layer].el, e, t);
                }.bind({ layer: d }),
                24
              )))),
            d++;
    ...
    n = function (t) {
      ...
      e &&
        ...
        t(),
        i && !i.el.contains(e) && (r("spill"), this.onSpill({ dragEl: o, putSortable: n })));
    };
  function ie() {}
  function re() {}
  (ie.prototype = {
            ...
            dragOverValid: function (t) {
              ...
              i.options.swap &&
                ...
                n &&
                  n !== t &&
                  ((t = ne),
                  (ne = !1 !== o(n) ? (k(n, i.swapClass, !0), n) : null),
        ...
        function t(o) {
          ...
          o.options.avoidImplicitDeselect ||
            (o.options.supportPointer
              ...
              : (h(document, "mouseup", this._deselectMultiDrag), h(document, "touchend", this._deselectMultiDrag))),
          ...
          (t.prototype = {
            ...
            clone: function (t) {
              var e = t.sortable,
                ...
                t = t.cancel;
              this.isMultiDrag &&
                (this.options.removeCloneOnHide || (de.length && le === e && (me(!0, n), o("clone"), t())));
            },
                  ...
                  1 < de.length
                    ? ((o = ue),
                      ...
                      r.options.animation &&
                        ...
                        o &&
                        he.forEach(function (t) {
                          r.addAnimationState({ target: t, rect: ce }),
                            (t.fromRect = ce),
            ...
            dragOverAnimationCapture: function (t) {
              ...
              de.forEach(function (t) {
                ...
                t.options.animation &&
                  ...
                  ((ce = a({}, e)), (e = b(se, !0)), (ce.top -= e.f), (ce.left -= e.e));
            },
            ...
            drop: function (t) {
              ...
              s &&
                ...
                (i = u.children),
                ge ||
                  (o.multiDragKey && !this.multiDragKeyDown && this._deselectMultiDrag(),
                  k(se, o.selectedClass, !~de.indexOf(se)),
                  ~de.indexOf(se)
                    ? (de.splice(de.indexOf(se), 1),
                      (ae = null),
                      G({ sortable: d, rootEl: c, name: "deselect", targetEl: se, originalEvent: s }))
                    : (de.push(se),
                      G({ sortable: d, rootEl: c, name: "select", targetEl: se, originalEvent: s }),
                      s.shiftKey && ae && d.el.contains(ae)
                        ? ((r = j(ae)),
                          (a = j(se)),
                          ~r &&
                            ~a &&
                            r !== a &&
                            (function () {
                              for (var e, t = r < a ? ((e = r), a) : ((e = a), r + 1), n = o.filter; e < t; e++)
                                ~de.indexOf(i[e]) ||
                                  (P(i[e], o.draggable, u, !1) &&
                                    ((n &&
                                      ("function" == typeof n
                                        ? n.call(d, s, i[e], d)
                ...
                ge &&
                  this.isMultiDrag &&
                  ((fe = !1),
                  (u[K].options.sort || u !== c) &&
                    1 < de.length &&
                    ((n = X(se)),
                    (e = j(se, ":not(." + this.options.selectedClass + ")")),
                    !pe && o.animation && (se.thisAnimationDuration = null),
                    ...
                    pe ||
                      (o.animation &&
                        ...
                        de.forEach(function (t) {
                          ...
                          (t.thisAnimationDuration = null),
                            t !== se &&
                              ((e = fe ? X(t) : n), (t.fromRect = e), f.addAnimationState({ target: t, rect: e }));
                        })),
                      ve(),
                      de.forEach(function (t) {
              ...
              return (
                de.forEach(function (t) {
                  ...
                  o.push({ multiDragElement: t, index: t.sortableIndex }),
                    (e = fe && t !== se ? -1 : fe ? j(t, ":not(." + n.options.selectedClass + ")") : j(t)),
