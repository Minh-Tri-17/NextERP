...
builder.Services.AddScoped<IHistoryNotificationAPIService, HistoryNotificationAPIService>();
builder.Services.AddScoped<IHistoryMailAPIService, HistoryMailAPIService>();
