    ...
    public class SpaServiceCategoryService : ISpaServiceCategoryService
    {
        ...
        public async Task<APIBaseResult<PagingResult<SpaServiceCategoryModel>>> GetPaging(Filter filter)
        {
            ...
            if (!string.IsNullOrEmpty(filter.KeyWord))
            {
                ...
                query = query.Where(x => !string.IsNullOrEmpty(x.SpaServiceCaterogyCode)
                    && x.SpaServiceCaterogyCode.ToLower().Contains(keyword));
            }
        ...
        public async Task<APIBaseResult<byte[]>> Export(Filter filter)
        {
            ...
            var worksheet = workbook.Worksheets.Add(ObjectNames.SpaServiceCategory);

            var listSpaServiceCategory = new List<SpaServiceCategory>();
            DataHelper.MapAudit(items, listSpaServiceCategory, string.Empty);
