...
namespace NextERP.BLL.Service
{
    public class ProductService : IProductService
    {
            ...
            foreach (var product in listProduct)
            {
                ...
                foreach (var productImageByProduct in listProductImageByProduct)
                {
                    if (productImageByProduct.ImagePath != null)
                        await _storageService.DeleteFileAsync(productImageByProduct.ImagePath, Constants.ProductsFolderPath);
                }
        ...
        {
            var fullImagePath = _storageService.GetFileUrl(imagePath, Constants.ProductsFolderPath);
        ...
        private async Task<string> SaveFile(IFormFile file)
        {
            ...
            await _storageService.SaveFileAsync(file.OpenReadStream(), fileName, Constants.ProductsFolderPath);
