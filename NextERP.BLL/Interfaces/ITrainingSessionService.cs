...
namespace NextERP.BLL.Interface
{
    public interface ITrainingSessionService
    {
        ...
        public Task<APIBaseResult<PagingResult<TrainingSessionModel>>> GetPaging(TrainingSessionModel request);
        public Task<APIBaseResult<bool>> Import(IFormFile fileImport);
        public Task<APIBaseResult<byte[]>> Export(TrainingSessionModel request);
    }
}
