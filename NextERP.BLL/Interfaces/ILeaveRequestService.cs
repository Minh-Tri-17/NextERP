...
namespace NextERP.BLL.Interface
{
    public interface ILeaveRequestService
    {
        ...
        public Task<APIBaseResult<PagingResult<LeaveRequestModel>>> GetPaging(LeaveRequestModel request);
        public Task<APIBaseResult<bool>> Import(IFormFile fileImport);
        public Task<APIBaseResult<byte[]>> Export(LeaveRequestModel request);
    }
}
